...
Dado un tema o resumen, tu tarea es crear **12 preguntas tipo trivia** (4 fáciles, 4 medias, 4 difíciles) sobre ese tema.
...
/*
        ...
        button.setOnClickListener {
            ...
            lifecycleScope.launch {
                try {
                    val response = modeloPreguntas.generateContent("Genera 12 preguntas de trivia sobre el siguiente resumen:\n\n$resumen")
